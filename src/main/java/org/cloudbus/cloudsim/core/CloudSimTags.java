...
public class CloudSimTags {
	...
	/**
	 * Denotes a request to migrate some low order VM out to another Host, so the high order VM can migrate in
	 */
	public static final int VM_CREATE_COMPLETE = BASE+49;
	public static final int ORDERED_VM_CREATE = BASE+50;
	public static final int ORDERED_VM_CREATE_COMPLETE = BASE + 51;
	public static final int VM_MIGRATE_FOR_VM = BASE + 52;
	public static final int VM_MIGRATE_FOR_VM_COMPLETE = BASE+53;
	
	
	public static final int VM_MIGRATE_CREATE = BASE+54;
	public static final int VM_MIGRATE_CREATE_COMPLETE = BASE+55;
	public static final int ORDERED_VM_MIGRATE_CREATE = BASE+56;
	public static final int ORDERED_VM_MIGRATE_CREATE_COMPLETE = BASE + 57;
	/** Private Constructor */
