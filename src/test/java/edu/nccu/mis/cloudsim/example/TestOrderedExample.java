...
public class TestOrderedExample
{

    @Test
    public void testOrderedExample()
    {
	main(new String[0]);
    }
	...
	try
	{
	    ...
	    // create two VMs
	    ProfiledVM vm1 = ProfiledVM.genDefaultProfiledVM(vmid, brokerId, vmm, VMType.CPU, VMOrder.HIGH, new CloudletSchedulerTimeShared());

	    vmid++;
	    ProfiledVM vm2 = ProfiledVM.genDefaultProfiledVM(vmid, brokerId, vmm, VMType.CPU, VMOrder.HIGH, new CloudletSchedulerTimeShared());
